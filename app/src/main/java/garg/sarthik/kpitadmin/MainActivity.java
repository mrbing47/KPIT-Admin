    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == POJODetails.REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Variables.colAdmins.document(Variables.firebaseUser.getUid()).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    @Override
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        if (documentSnapshot.exists()) {

                            Variables.admin = documentSnapshot.toObject(Admin.class);

                            Log.e(TAG, "onSuccess: " + Variables.admin.getEmailId() );
